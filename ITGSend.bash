...
echo $timestamp
# touch recv_10.0.0.2_$timestamp.log
...
ITGSend -T UDP -a 127.0.0.1 -rp $port2 -C $rate -c 1200 -t 2000 -x ./logs/receiver_$addr1.log -l ./logs/sender_$addr1.log -Sda $addr2 -Sdp 11234 -p 2 -Fp ./data_files/random1M.txt
# ITGSend -T UDP -a 127.0.0.1 -rp $port2 -C $rate -c 1200 -t 2000 -x ./logs/receiver_$addr1_$timestamp.log -l ./logs/sender_$addr1_$timestamp.log -Sda $addr2 -Sdp 11234 -p 0
