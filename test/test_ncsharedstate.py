...
class TestSharedState(unittest.TestCase):
    ...
    def test_getOutputQueueReady(self):
        ...
        cope_pkt = COPE_classes.COPE_packet() / scapy.Raw("NC Runner test2")
    ...
    def test_peekPacketFromQueue(self):
        ...
        cope_pkt2 = COPE_classes.COPE_packet() / scapy.Raw("NC Runner test2")
